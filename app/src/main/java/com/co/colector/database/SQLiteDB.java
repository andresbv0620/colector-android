...
public class SQLiteDB extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE registros (id INTEGER PRIMARY KEY AUTOINCREMENT, catalogoId TEXT, dbSistema TEXT, sistemaId TEXT, tablet_id TEXT, grupoEntrada TEXT, tabId TEXT, respuesta TEXT, usuarioId TEXT, entradaId TEXT);");
